...
% 
This limitation becomes especially relevant in deep models that rely on
different approaches to information storage. Transformers employ the self-attention mechanism to 
process sequences, where information is mixed across tokens at each layer without an explicit notion 
...
state after processing the context, the model avoids recomputing the context and achieves inference 
