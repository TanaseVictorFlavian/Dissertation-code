...
%
Memory caching in a question-answering setup yields up to a \textbf{2.7$\times$ speedup} in generation 
time by reusing precomputed memory states and avoiding redundant computation over long contexts 
across 102 question answer pairs.
...
Despite the promising results, the model underperforms compared to a transformer similar in size
