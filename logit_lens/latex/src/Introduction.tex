...
using xLSTM-7B and Mistral-7B. To analyze this evolution further, the fourth phase applies an unsupervised clustering 
pipeline to the hidden states across successive blocks, mapping how token representations transition through the depth 
of the network. \\ \\
%
The final two phases of the interpretability study focus on the temporal dynamics of the architecture. 
